...
console.log(chalk.yellow(`Developed by Ahmed Ullah Farooqi                                                                                
`));
    ...
    while (repeat) {
        ...
        for (let i = 3; i > 0;) {
            ...
            if (guessNumber === user.One) {
                points += 10;
                console.log(`${chalk.yellow.bold("Congrats!")} you earned ${points} points.`);
            }
            else {
                i--;
                if (i != 0) {
                    console.log(`${chalk.magenta.bold.underline("Try Again!")} you have ${chalk.bold(i)} lives remaining`);
                }
            }
        }
