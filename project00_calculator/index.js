...
const startMessage = async () => {
    ...
    await stopAnimation();
    rainbow.stop();
    console.log(chalk.green(`Developed by Ahmed Ullah Farooqi`));
};
await startMessage();
...
const startAgain = async () => {
    do {
        ...
        if (userAnswer.userWant === "No thanks!") {
            console.log(chalk.bgGreen.white.bold("Thank you for using my CLI calculator! - Ahmed Ullah Farooqi"));
        }
